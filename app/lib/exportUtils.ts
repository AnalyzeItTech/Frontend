      ...
      <body>
        ...
        <div class="executive-summary">
          ...
          <p>
            ...
            All referenced figures are derived from authoritative warehouse connectors with zero synthetic hallucination.
          </p>
        </div>
        ...
        <div style="margin-top: 36pt; padding-top: 12pt; border-top: 1pt solid #dddddd; font-size: 9pt; color: #888888;">
          Report generated automatically by AnalyzeIt. Integrity verified via monotonic version control.
        </div>
      </body>
    </html>
  `;
