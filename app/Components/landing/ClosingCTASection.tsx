  ...
  return (
    <section className="relative py-32 md:py-48 px-6 md:px-16 max-w-5xl mx-auto text-center space-y-8 pointer-events-auto">
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#B8A9C9]/20 border border-[#B8A9C9]/30 text-xs font-mono tracking-widest uppercase text-[#4A4238]/70"
      >
      ...
      <motion.h2
        ...
        className="font-serif text-5xl sm:text-6xl md:text-7xl text-[#4A4238] font-normal leading-[1.08] max-w-3xl mx-auto"
      >
      ...
      <motion.p
        ...
        className="text-base md:text-lg text-[#4A4238]/70 max-w-xl mx-auto leading-relaxed"
      >
